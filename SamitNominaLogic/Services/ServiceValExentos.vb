...
Public Class ServiceValExentos
    ...
    Public Function UpsertValExento(ValExento As ValoresExentos) As JArray
        ...
        fila("Vigente") = ValExento.TipoValor

        Dim datos As New JArray()
        datos.Add(fila)

        ' Hacer la petición con el JArray como segundo parámetro
        Peticion.PostParametros("ValExento", datos)

        Return datos
    End Function

    Public Function EliminarValExento(ValExento As ValoresExentos) As JArray
        Dim Peticion As New ParametrosApi()
        ...
        datos.Add(fila)
        ' Hacer la petición con el JArray como segundo parámetro
        'Peticion.DeleteParametros("ValExento", datos)
    End Function
End Class
