...
<SqlTable(Nombre:="NominaLiquidaExtraordinariaContratos", BaseDatos:=DatabasesSamit.NominaFull, Version:=1)>
Public Class NominaLiquidaExtraordinariaContratos
    ...
    <SqlColumn(Nombre:="NominaLiquidaExtraordinaria", TipoDato:=SqlType.Int, AceptaNull:=False)>
    Public Property NominaLiquidaExtraordinaria As Integer
