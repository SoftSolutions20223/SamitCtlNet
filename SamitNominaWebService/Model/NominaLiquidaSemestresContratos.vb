...
<SqlTable(Nombre:="NominaLiquidaSemestresContratos", BaseDatos:=DatabasesSamit.NominaFull, Version:=1)>
Public Class NominaLiquidaSemestresContratos
    ...
    <SqlColumn(Nombre:="NominaLiquidaSemestres", TipoDato:=SqlType.Int, AceptaNull:=False)>
